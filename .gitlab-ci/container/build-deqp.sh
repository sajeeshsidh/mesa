...
vk_cts_commits_to_backport=(
    ...
    # Fix depth/stencil input attachment mapping in VK_KHR_dynamic_rendering_local_read tests
    b9306e076b5b027ed1e938aba8c58a2192ed5ace

    # Fix input attachment mapping in VK_KHR_dynamic_rendering_local_read tests even more
    bce68dc0cce49adc2ffcfedb9f415760a0fabb52

    # Various fixes including use-after-free for VK_KHR_dynamic_rendering_local_read
    28cffb571fd7cd63251c98b06a2c2a005e95ae3d
)
