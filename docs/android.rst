...
.. code-block:: sh
   ...
   cp ${INSTALL_PREFIX_64}/lib/dri/swrast_dri.so prebuilts/mesa/x86_64/
   ...
   cp ${INSTALL_PREFIX_32}/lib/dri/swrast_dri.so prebuilts/mesa/x86
   ...
   patchelf --set-soname swrast_dri.so prebuilts/mesa/x86_64/swrast_dri.so
   ...
   patchelf --set-soname swrast_dri.so prebuilts/mesa/x86/swrast_dri.so
...
.. code-block::
   ...
   cc_prebuilt_library_shared {
       ...
       arch: {
           x86_64: {
               srcs: ["x86_64/swrast_dri.so"],
           },
           x86: {
               srcs: ["x86/swrast_dri.so"],
           },
       },
       strip: {
           none: true,
       ...
       relative_install_path: "egl",
       shared_libs: ["libc", "libdl", "liblog", "libm", "libcutils", "libdrm", "liblog", "libsync", "libz"],
       check_elf_files: false,
       vendor: true
   }
...
.. code-block:: sh
   ...
   /vendor/lib(64)?/egl/swrast_dri\.so u:object_r:same_process_hal_file:s0
